...
- [ ] À définir : écran dédié ou tooltip au tap sur un mot dans `PhraseListScreen`
- [ ] Affichage de l'exemple : `dict_translation.example ?? dict_entry.example`
- [ ] Tableau de conjugaison/déclinaison depuis `dict_form` (features + pronouns)
- [ ] Passé composé FR : reconstruction avec liste statique être/avoir
